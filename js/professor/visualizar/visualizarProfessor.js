...
async function buscarProfessor() {
    ...
    const resposta = await fetch(`http://3.81.97.189:8080/api/usuarios/professor/paginado?page=${paginaAtual}` + Filters.buildQueryString(), {
        method: 'GET',
        headers: {
...
async function deletarProfessor(id) {
    const respostaDelete = await fetch(`http://3.81.97.189:8080/api/usuarios/Professor/${id}`, {
        method: "DELETE",
        headers: {
...
async function atualizarMetaProfessor(id) {
    try {
        ...
        const resposta = await fetch(`http://3.81.97.189:8080/api/metas/${id}`, {
            method: "PUT",
            body: meta,
...
async function atualizarStatus(id, novoStatus) {
    try {
        const resposta = await fetch(`http://3.81.97.189:8080/api/usuarios/desativar/${id}`, {
            method: "PUT",
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function importarDados() {
    ...
    try {
        ...
        const response = await fetch('http://3.81.97.189:8080/api/archive/txt/usuarios', {
            method: 'POST',
            body: formData,
            headers: {
                'Authorization': `Bearer ${sessionStorage.getItem('token')}`
...
async function exportarDados() {
    ...
    try {
        const response = await fetch(`http://3.81.97.189:8080/api/archive/csv/usuarios/${tipo}`, {
            method: 'GET',
            headers: {
