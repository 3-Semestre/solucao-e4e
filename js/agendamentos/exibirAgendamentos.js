...
async function carregarAgendamentos(pagina) {
    ...
    try {
        ...
        const resposta = await fetch(`http://3.81.97.189:8080/api/agendamento/historico/${id}?page=${pagina}&tempo=${tempo}` + Filters.buildQueryString(), {
            method: 'GET',
            headers: {
...
async function buscarDetalhes(id) {
    const respostaAgendamento = await fetch(`http://3.81.97.189:8080/api/agendamento/${id}`, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
    ...
    const respostaHistorico = await fetch(`http://3.81.97.189:8080/api/historico-agendamento/${id}`, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
...
async function novoStatus(id, statusId) {
    try {
        ...
        const respostaStatus = await fetch(`http://3.81.97.189:8080/api/status/${statusId}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
        ...
        const novoStatus = await fetch("http://3.81.97.189:8080/api/historico-agendamento", {
            method: "POST",
...
async function novoAssunto(id, assunto) {
    try {
        const novoStatus = await fetch(`http://3.81.97.189:8080/api/agendamento/${id}`, {
            method: "PUT",
            body: assunto,
            headers: { 'Authorization': `Bearer ${token}`, "Content-type": "application/json; charset=UTF-8" }
        });
...
async function novoStatusTransferencia(idAgendamento, novoProfessorId) {
    try {
        const resposta = await fetch(`http://3.81.97.189:8080/api/agendamento/transferir`, {
            method: "POST",
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function buscarProfessoreDisponveis() {
    ...
    try {
        const resposta = await fetch("http://3.81.97.189:8080/api/horario-professor/transferencia", {
            method: "POST",
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
